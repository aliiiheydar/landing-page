...
import getBlogsByCategoryId from './getBlogsByCategoryId'
 ...
 *                   type: string
 */
panelBlogRouter.get('/category/:categoryId', auth('admin'), getBlogsByCategoryId)
 ...
 *                   type: string
 */
websiteBlogRouter.get('/category/:categoryId', getBlogsByCategoryId)
